...
ax1.scatter( x_round, t_sum_wspt, label = 'WSPT' )
ax1.scatter( x_round, t_sum_edf_m, label = 'WEDF' )
ax1.plot( x_round, t_sum_default, label='default scheduler'  )
ax1.plot( x_round, t_sum_edf, label='EDF' )
ax1.plot( x_round, t_sum_wspt, label='WSPT' )
ax1.plot( x_round, t_sum_edf_m, label='WEDF' )
...
ax2.scatter( x_round, u_sum_wspt, label='WSPT' )
ax2.scatter( x_round, u_sum_edf_m, label='WEDF' )
ax2.plot( x_round, u_sum_default, label='default scheduler' )
ax2.plot( x_round, u_sum_edf, label='EDF' )
ax2.plot( x_round, u_sum_wspt, label='WSPT' )
ax2.plot( x_round, u_sum_edf_m, label='WEDF' )
